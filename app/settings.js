...
function SettingsPage({user,theme,setTheme,onSignOut,team,setTeam,loading,clients=[]}){
  ...
  const NAVS=isAdmin
    ?[['account','ti-user','My account'],['team','ti-users','Team members'],['onboarding','ti-clipboard-check','Onboarding'],['social','ti-brand-instagram','Connected accounts'],['agency','ti-building-bank','Agency & invoicing'],['appearance','ti-palette','Appearance'],['integrations','ti-plug','Integrations'],...(WhatsAppSettingsSection?[['whatsapp','ti-brand-whatsapp','WhatsApp']]:[]),['trash','ti-trash','Trash'],['audit','ti-history','Activity log'],['backup','ti-database-export','Backup & health'],['danger','ti-alert-triangle','Danger zone']]
    :[['account','ti-user','My account'],['appearance','ti-palette','Appearance'],['integrations','ti-plug','Integrations'],...(WhatsAppSettingsSection?[['whatsapp','ti-brand-whatsapp','WhatsApp']]:[]),['danger','ti-alert-triangle','Danger zone']];
