...
//   { TrialBanner, PaywallScreen, BillingSettings, ContactPhoneGate, needsPaywall, needsContactPhone }.
...
(function(){
  function buildPaywall(deps){
    ...
    return { TrialBanner, PaywallScreen, BillingSettings, ContactPhoneGate, needsPaywall, needsContactPhone };
  }
